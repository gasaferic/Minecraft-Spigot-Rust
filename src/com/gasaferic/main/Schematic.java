...
public class Schematic {
    ...
    public static void save(Player player, String schematicName) {
        try {
            File schematic = new File("plugins/WorldEdit/schematics/" + schematicName);
            File dir = new File("plugins/WorldEdit/schematics/");
            if (!dir.exists())
                dir.mkdirs();
    ...
    public static void paste(String schematicName, Location pasteLoc, boolean noAir) {
        try {
            File dir = new File("plugins/WorldEdit/schematics/" + schematicName);
            ...
            clipboard.paste(editSession, BukkitUtil.toVector(pasteLoc), noAir);
            editSession.flushQueue();
