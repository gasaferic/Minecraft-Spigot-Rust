...
public class menuAbbandonoConferma {

	public static Inventory openMenuConferma(Player player) {
		
		Inventory menucasa = Bukkit.createInventory(player, 27, "§7§lConferma Abbandono");

		addItem(351, 11, 10, menucasa, "§a§lConferma");
		addItem(351, 15, 1, menucasa, "§4§lAnnulla");
		return menucasa;
	}
